                        ...
                        <div class="logo text-center">
                            ...
                            <h1>
                                <a href="index.php?controller=home&action=index">
                                    <img src="assets/images/logo.png" alt="Digital Store" class="img-responsive" />
                                </a>
                            </h1>
                        ...
                        <div class="row">
                            <div class="col-md-4 wow slideInLeft">
                                <div class="content-register-news">
                                    ...
                                    <p>Để cập nhật những thông tin mới nhất về Digital Shop</p>
                                </div>
                            </div>
                            <div class="col-md-4">
...
<!--
                ...
                <div class="coppyright">
                    <p>Copyright &copy; 2024 Digital Shop.</p>
                </div>
            </footer>
